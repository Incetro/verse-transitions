...
extension Reducer {
    ...
    public func presenting<LocalState, LocalAction, LocalEnvironment>(
        ...
        action toLocalAction: EnumKeyPath<Action, (LocalState.ID, LocalAction)>,
        ...
        return Reducer { state, action, environment in
            let oldIds = OrderedSet<LocalState.ID>(state[keyPath: toLocalState].ids)
            ...
            let newIds = OrderedSet<LocalState.ID>(state[keyPath: toLocalState].ids)
...
// MARK: - ReducerPresentingForEachAction
...
// MARK: - ReducerPresentingForEachEffectId
